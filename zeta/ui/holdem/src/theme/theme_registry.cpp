            ...
            static const std::array<registered_theme, 3> registry{{
                registered_theme{
                    ...
                    .tokens = theme_tokens{
                        ...
                        .text_muted = "#8a9099",
                        .accent_primary = "#C9943A",
                        .accent_secondary = "#8ea8c0",
                        .action_primary = "#8ea8c0",
                        .action_primary_hover = "#a5bdd2",
                        .action_positive = "#5FBF68",
                        .action_negative = "#E34F4F",
                        .ev_positive = "#a8c8a8",
                        .ev_negative = "#ff6b6b",
                        .ev_neutral = "#9aa1ab",
                        .range_heat = {"#252a33", "#5A4426", "#946F31", "#C9943A"},
                        .warning = "#C9943A",
                        .error = "#ff6b6b",
                        .success = "#a8c8a8",
                        .selection = "rgba(142, 168, 192, 26)",
                        .document_selection = "rgba(142, 168, 192, 26)",
                        .active_surface = "rgba(142, 168, 192, 34)",
                        .button_text = "#1d2128",
                ...
                registered_theme{
                    ...
                    .tokens = theme_tokens{
                        ...
                        .text_muted = "#707070",
                        .accent_primary = "#B9822E",
                        .accent_secondary = "#95a8b8",
                        .action_primary = "#95a8b8",
                        .action_primary_hover = "#b0c4d0",
                        .action_positive = "#4F9B4E",
                        .action_negative = "#C83F3F",
                        .ev_positive = "#3f7d3f",
                        .ev_negative = "#c0392b",
                        .ev_neutral = "#707070",
                        .range_heat = {"#f0efec", "#F2DEB8", "#D5A658", "#B9822E"},
                        .warning = "#B9822E",
                        .error = "#C83F3F",
                        .success = "#3f7d3f",
                        .selection = "rgba(149, 168, 184, 34)",
                        .document_selection = "rgba(149, 168, 184, 34)",
                        .active_surface = "rgba(149, 168, 184, 51)",
                        .button_text = "#000000",
                ...
                registered_theme{
                    ...
                    .tokens = theme_tokens{
                        ...
                        .text_muted = "#b8bec6",
                        .accent_primary = "#E6B04A",
                        .accent_secondary = "#b5c8d8",
                        .action_primary = "#b5c8d8",
                        .action_primary_hover = "#d0dde7",
                        .action_positive = "#70D36F",
                        .action_negative = "#FF6262",
                        .ev_positive = "#9fd09f",
                        .ev_negative = "#ff7373",
                        .ev_neutral = "#e7e2dc",
                        .range_heat = {"#1b2026", "#5C4925", "#A47A2D", "#E6B04A"},
                        .warning = "#e6c15a",
                        .error = "#ff7373",
                        .success = "#9fd09f",
                        .selection = "#252d35",
                        .document_selection = "#252d35",
                        .active_surface = "#293541",
                        .button_text = "#0b0d10",
