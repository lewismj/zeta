            ...
            static const std::array<registered_theme, 3> registry{{
                registered_theme{
                    ...
                    .tokens = theme_tokens{
                        ...
                        .action_positive = "#6fa36f",
                        .action_negative = "#d94f4f",
                        .ev_positive = "#a8c8a8",
                        .ev_negative = "#ff6b6b",
                        .ev_neutral = "#9aa1ab",
                        .range_heat = {"#252a33", "#3a3239", "#6d5060", "#b77a8a"},
                        .warning = "#9f8668",
                        .error = "#ff6b6b",
                        .success = "#a8c8a8",
                ...
                registered_theme{
                    ...
                    .tokens = theme_tokens{
                        ...
                        .ev_negative = "#c0392b",
                        .ev_neutral = "#707070",
                        .range_heat = {"#f0efec", "#eadde1", "#c89aa7", "#a66f7f"},
                        .warning = "#9f8668",
                        .error = "#c0392b",
                        .success = "#3f7d3f",
                ...
                registered_theme{
                    ...
                    .tokens = theme_tokens{
                        ...
                        .action_positive = "#9fd09f",
                        .action_negative = "#ff7373",
                        .ev_positive = "#9fd09f",
                        .ev_negative = "#ff7373",
                        .ev_neutral = "#e7e2dc",
                        .range_heat = {"#1b2026", "#343b44", "#855c6a", "#d28aa0"},
                        .warning = "#e6c15a",
                        .error = "#ff7373",
                        .success = "#9fd09f",
                        .selection = "#252d35",
